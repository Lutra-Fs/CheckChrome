...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/stable-x86.xml
...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/stable-x64.xml
...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/beta-x86.xml
...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/beta-x64.xml
...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/dev-x86.xml
...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/dev-x64.xml
...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/canary-x86.xml
...
curl -s "https://tools.google.com/service/update2" --data "<?xml version='1.0' encoding='UTF-8'?>
            ...
            </request>" > ./tmp/googlechrome/checker/canary-x64.xml
